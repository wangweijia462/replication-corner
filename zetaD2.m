...
% sensitivity
zetaND     = 0.6;   % sensitivity
zetaED     = 0.6;   % sensitivity
...
% output
delta_zetaD2_BM = [delta_n_BM;delta_e_prime_BM;delta_omega_BM;delta_W_BM;delta_L0_BM;delta_L1_BM]; 
delta_zetaD2_BP = [delta_n_BP;delta_e_prime_BP;delta_omega_BP;delta_W_BP;delta_L0_BP;delta_L1_BP]; 
delta_zetaD2_AE = [delta_n_AE;delta_e_prime_AE;delta_omega_AE;delta_W_AE;delta_L0_AE;delta_L1_AE]; 
delta_zetaD2_AN = [delta_n_AN;delta_e_prime_AN;delta_omega_AN;delta_W_AN;delta_L0_AN;delta_L1_AN]; 

save delta_zetaD2 delta_zetaD2_BM delta_zetaD2_BP delta_zetaD2_AN delta_zetaD2_AE;  % zetaND = zetaED = 0.6
