...
point estimate identical to Column~1, with a tighter SE reflecting the
switch to continuous-prestige specification).
...
$\pm$0.2 log-units for the binary-prestige interactions) indicate that
the present design would be unable to reliably detect effects smaller
than roughly half a standard deviation; larger samples are needed to
test for small-to-medium interaction effects with adequate power.
...
Seventh, using a GPT-4o model to score abstracts for AI-writing style
