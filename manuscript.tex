...
\citep[documenting the increasing prevalence and characteristic
patterns of LLM-assisted academic writing]{Liang2024}\citep{Biber2016}.
...
indicating substantial agreement between human annotators.
Second, ChatGPT evaluated each target abstract holistically against
this dictionary, producing a 0--1 score that reflects both explicit
marker density and the overall structural-formulaic character of
the abstract text.
...
scoring pipeline and human judgment.The resulting score ranges from 0 to 1
