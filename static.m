...
figure(1) 
subplot(3,2,1);
plot(BM_vector(1:T),n_vector_BM(1:T),'k-',BP_vector(1:T),n_vector_BP(1:T),'k--','LineWidth',1);
axis([1 2 0.5 1.2])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('生育数量','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);
legend('脑力工作偏向型人工智能技术进步','体力工作偏向型人工智能技术进步','Fontsize',5,'location','north')
legend('boxoff');

subplot(3,2,2);
plot(BM_vector(1:T),e_prime_vector_BM(1:T),'k-',BP_vector(1:T),e_prime_vector_BP(1:T),'k--','LineWidth',1);
axis([1 2 5 10])
set(gca,'FontSize',6); 
ylabel('生育质量','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);

subplot(3,2,3);
plot(BM_vector(1:T),omega_vector_BM(1:T),'k-',BP_vector(1:T),omega_vector_BP(1:T),'k--','LineWidth',1);
axis([1 2 0.6 0.9])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('女性工资/男性工资','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);

subplot(3,2,4);
plot(BM_vector(1:T),W_vector_BM(1:T),'k-',BP_vector(1:T),W_vector_BP(1:T),'k--','LineWidth',1);
axis([1 2 2 6])
set(gca,'FontSize',6); 
ylabel('家庭工资收入','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);

subplot(3,2,5);
plot(BM_vector(1:T),L0_vector_BM(1:T),'k-',BP_vector(1:T),L0_vector_BP(1:T),'k--','LineWidth',1);
axis([1 2 0.5 0.7])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('女性劳动供给时间','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);

subplot(3,2,6);
plot(BM_vector(1:T),L1_vector_BM(1:T),'k-',BP_vector(1:T),L1_vector_BP(1:T),'k--','LineWidth',1);
axis([1 2 0.7 0.9])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('男性劳动供给时间','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);
...
figure(2)  
subplot(3,2,1);
plot(AN_vector(1:T),n_vector_AN(1:T),'k-',AE_vector(1:T),n_vector_AE(1:T),'k--','LineWidth',1);
axis([1 2 0.5 1.2])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('生育数量','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);
legend('生育数量偏向型人工智能技术进步','生育质量偏向型人工智能技术进步','Fontsize',5,'location','north')
legend('boxoff');

subplot(3,2,2);
plot(AN_vector(1:T),e_prime_vector_AN(1:T),'k-',AE_vector(1:T),e_prime_vector_AE(1:T),'k--','LineWidth',1);
axis([1 2 4 10])
set(gca,'FontSize',6); 
ylabel('生育质量','Fontsize',6);
xlabel('技术进步幅度','Fontsize',6);
...
subplot(3,2,3);
plot(AN_vector(1:T),omega_vector_AN(1:T),'k-',AE_vector(1:T),omega_vector_AE(1:T),'k--','LineWidth',1);
axis([1 2 0.6 0.9])
set(gca,'FontSize',6);
ytickformat('%.2f');
ylabel('女性工资/男性工资','Fontsize',6);
...
subplot(3,2,4);
plot(AN_vector(1:T),W_vector_AN(1:T),'k-',AE_vector(1:T),W_vector_AE(1:T),'k--','LineWidth',1);
axis([1 2 2 2.5])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('家庭工资收入','Fontsize',6);
...
subplot(3,2,5);
plot(AN_vector(1:T),L0_vector_AN(1:T),'k-',AE_vector(1:T),L0_vector_AE(1:T),'k--','LineWidth',1);
axis([1 2 0.5 0.7])
set(gca,'FontSize',6);
ytickformat('%.2f');
ylabel('女性劳动供给时间','Fontsize',6);
...
subplot(3,2,6);
plot(AN_vector(1:T),L1_vector_AN(1:T),'k-',AE_vector(1:T),L1_vector_AE(1:T),'k--','LineWidth',1);
axis([1 2 0.7 0.9])
set(gca,'FontSize',6); 
ytickformat('%.2f');
ylabel('男性劳动供给时间','Fontsize',6);
...
% output
delta_baseline_BM = [delta_n_BM;delta_e_prime_BM;delta_omega_BM;delta_W_BM;delta_L0_BM;delta_L1_BM]; 
delta_baseline_BP = [delta_n_BP;delta_e_prime_BP;delta_omega_BP;delta_W_BP;delta_L0_BP;delta_L1_BP]; 
delta_baseline_AE = [delta_n_AE;delta_e_prime_AE;delta_omega_AE;delta_W_AE;delta_L0_AE;delta_L1_AE]; 
delta_baseline_AN = [delta_n_AN;delta_e_prime_AN;delta_omega_AN;delta_W_AN;delta_L0_AN;delta_L1_AN]; 

save delta_baseline delta_baseline_BM delta_baseline_BP delta_baseline_AN delta_baseline_AE;
