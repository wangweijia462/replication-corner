...
significant across any specification (all $p>.10$), suggesting that peer-reviewed
...
These results reveal a boundary condition for Jo and Li's (2026) findings
and raise new questions about the conditions under which institutional
prestige shapes knowledge diffusion.
...
and indicating substantial reliability between human annotators.
...
effects smaller than roughly one quarter of a standard deviation;
